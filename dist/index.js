...
var deepmerge = _interopDefault(__nccwpck_require__(6323));
var isPlainObject = _interopDefault(__nccwpck_require__(8840));
var urlTemplate = _interopDefault(__nccwpck_require__(464));
...
async function run() {
  try {
    ...
    const deployment_id =
      core.getInput("deployment-id", {required: false}) ||
